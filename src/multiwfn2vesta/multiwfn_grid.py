...
GRID_FUNCTIONS: Tuple[GridFunction, ...] = (
    ...
    GridFunction(
        ...
        "userfunc.cub",
        "positive-esp",
        ("positive-mep", "esp-positive", "mep-positive", "esp-pos", "mep-pos"),
        mapped_preset="surface-map",
        default_user_function_index=101,
    ),
    GridFunction(
        "negative-esp",
        100,
        "userfunc.cub",
        "negative-esp",
        ("negative-mep", "esp-negative", "mep-negative", "esp-neg", "mep-neg"),
        mapped_preset="surface-map",
        default_user_function_index=102,
    ),
    GridFunction(
        ...
        "userfunc.cub",
        "electric-field-magnitude",
        ("electric-field", "efield", "e-field", "esp-gradient-magnitude", "mep-gradient-magnitude"),
        mapped_preset="surface-map",
        default_user_function_index=103,
    ),
    ...
    GridFunction(
        ...
        "userfunc.cub",
        "shape-function",
        ("shape", "density-shape-function"),
        mapped_preset="surface-map",
        default_user_function_index=9,
    ),
    GridFunction(
        ...
        "userfunc.cub",
        "average-local-electrostatic-potential",
        ("average-local-esp", "local-average-esp", "average-local-mep", "totesp-over-rho"),
        mapped_preset="surface-map",
        default_user_function_index=8,
    ),
    GridFunction(
        ...
        "userfunc.cub",
        "energy-density",
        ("virial-field", "potential-energy", "local-potential-energy-density"),
        mapped_preset="surface-map",
        default_user_function_index=10,
    ),
    GridFunction(
        "energy-density",
        100,
        ...
        mapped_preset="surface-map",
        default_user_function_index=11,
    ),
    GridFunction(
    ...
    GridFunction(
        ...
        "userfunc.cub",
        "energy-density",
        ("nuclear-attraction-energy-density", "nuclear-attraction-potential-energy"),
        mapped_preset="surface-map",
        default_user_function_index=12,
    ),
    GridFunction(
        ...
        ("g-over-rho", "lagkin-over-rho", "closed-shell-discriminator"),
        mapped_preset="surface-map",
        default_user_function_index=13,
    ),
    GridFunction(
        "bond-metallicity",
        100,
        "userfunc.cub",
        "bond-metallicity",
        ("metallicity", "rho-over-laplacian"),
        mapped_preset="surface-map",
        default_user_function_index=15,
    ),
    GridFunction(
        "dimensionless-bond-metallicity",
        100,
        "userfunc.cub",
        "bond-metallicity",
        ("dimensionless-metallicity", "normalized-bond-metallicity"),
        mapped_preset="surface-map",
        default_user_function_index=16,
    ),
    GridFunction(
        ...
        "userfunc.cub",
        "local-energy-per-electron",
        ("energy-per-electron", "local-energy-per-electron"),
        mapped_preset="surface-map",
        default_user_function_index=17,
    ),
    GridFunction(
        "momentum-fluctuation-magnitude",
        100,
        "userfunc.cub",
        "momentum-fluctuation",
        ("momentum-fluctuation", "electronic-momentum-fluctuation"),
        mapped_preset="surface-map",
        default_user_function_index=25,
    ),
    GridFunction(
        ...
        "userfunc.cub",
        "density-ellipticity",
        ("density-ellipticity", "rho-ellipticity", "ellipticity"),
        mapped_preset="surface-map",
        default_user_function_index=30,
    ),
    GridFunction(
        "eta-index",
        100,
        "userfunc.cub",
        "eta-index",
        ("eta", "density-eta-index"),
        mapped_preset="surface-map",
        default_user_function_index=31,
    ),
    GridFunction(
        "modified-eta-index",
        100,
        "userfunc.cub",
        "eta-index",
        ("eta-minus-one", "modified-eta"),
        mapped_preset="surface-map",
        default_user_function_index=32,
    ),
    GridFunction(
        "sci",
        100,
        "userfunc.cub",
        "sci",
        ("strong-covalent-interaction", "sci-index"),
        mapped_preset="surface-map",
        default_user_function_index=37,
    ),
    GridFunction(
        "stiffness",
        100,
        ...
        ("density-stiffness",),
        mapped_preset="surface-map",
        default_user_function_index=115,
    ),
    GridFunction(
    ...
    GridFunction(
        ...
        mapped_preset="surface-map",
        default_user_function_index=18,
    ),
    GridFunction(
        "sedd",
        100,
        ...
        mapped_preset="surface-map",
        default_user_function_index=19,
    ),
    GridFunction(
        "steric-energy-density",
        100,
        "userfunc.cub",
        "steric-energy-density",
        ("steric-density", "steric-energy", "steric-ked"),
        mapped_preset="surface-map",
        default_user_function_index=40,
    ),
    GridFunction(
        "steric-potential",
        100,
        "userfunc.cub",
        "sbl-potential",
        ("steric-pot", "weizsacker-potential", "weizpot"),
        mapped_preset="surface-map",
        default_user_function_index=41,
    ),
    GridFunction(
        "steric-charge",
        100,
        ...
        ("stericcharge",),
        mapped_preset="surface-map",
        default_user_function_index=42,
    ),
    GridFunction(
        ...
        "userfunc.cub",
        "sbl-force-magnitude",
        ("steric-force", "stericforce"),
        mapped_preset="surface-map",
        default_user_function_index=43,
    ),
    GridFunction(
        "pauli-potential",
        100,
        ...
        ("pauli-pot", "paulipot"),
        mapped_preset="surface-map",
        default_user_function_index=60,
    ),
    GridFunction(
        ...
        "userfunc.cub",
        "sbl-force-magnitude",
        ("pauli-force", "pauliforce"),
        mapped_preset="surface-map",
        default_user_function_index=61,
    ),
    GridFunction(
        "pauli-charge",
        100,
        ...
        ("paulicharge",),
        mapped_preset="surface-map",
        default_user_function_index=62,
    ),
    GridFunction(
        "quantum-potential",
        100,
        "userfunc.cub",
        "sbl-potential",
        ("quantum-pot", "quantumpot"),
        mapped_preset="surface-map",
        default_user_function_index=63,
    ),
    GridFunction(
        ...
        "userfunc.cub",
        "sbl-force-magnitude",
        ("quantum-force", "quantumforce"),
        mapped_preset="surface-map",
        default_user_function_index=64,
    ),
    GridFunction(
        "quantum-charge",
        100,
        ...
        ("quantumcharge",),
        mapped_preset="surface-map",
        default_user_function_index=65,
    ),
    GridFunction(
        ...
        "userfunc.cub",
        "sbl-force-magnitude",
        ("electrostatic-force", "elestatforce", "esp-force-magnitude"),
        mapped_preset="surface-map",
        default_user_function_index=66,
    ),
    GridFunction(
        ...
        "userfunc.cub",
        "sbl-charge",
        ("elestatcharge", "esp-charge"),
        mapped_preset="surface-map",
        default_user_function_index=67,
    ),
    GridFunction(
        ...
        "userfunc.cub",
        "sbl-energy-density",
        ("sbl-ee-density", "sbl-electronic-electrostatic-energy-density"),
        mapped_preset="surface-map",
        default_user_function_index=68,
    ),
    GridFunction(
        ...
        "userfunc.cub",
        "sbl-energy-density",
        ("sbl-eq-density", "sbl-quantum-energy-density-hamiltonian"),
        mapped_preset="surface-map",
        default_user_function_index=69,
    ),
    GridFunction(
        ...
        "userfunc.cub",
        "sbl-energy-density",
        ("sbl-eq-density-lagrangian", "sbl-quantum-energy-density-g"),
        mapped_preset="surface-map",
        default_user_function_index=-69,
    ),
    GridFunction(
        ...
        "userfunc.cub",
        "sbl-energy-density",
        ("sbl-energy-density", "sbl-total-density", "sbl-energy"),
        mapped_preset="surface-map",
        default_user_function_index=110,
    ),
    GridFunction(
        "sbl-total-potential",
        100,
        "userfunc.cub",
        "sbl-potential",
        ("sbl-potential", "sbl-pot", "sbl-all-potential"),
        mapped_preset="surface-map",
        default_user_function_index=111,
    ),
    GridFunction(
        ...
        "userfunc.cub",
        "sbl-force-magnitude",
        ("sbl-force", "sblallforce", "sbl-all-force"),
        mapped_preset="surface-map",
        default_user_function_index=112,
    ),
    GridFunction(
        "sbl-total-charge",
        100,
        "userfunc.cub",
        "sbl-charge",
        ("sbl-charge", "sbl-all-charge"),
        mapped_preset="surface-map",
        default_user_function_index=113,
    ),
    GridFunction(
        "weizsacker-ked",
        100,
